(function () {
  ...
  (function newFact() {
    ...
    'As instructed from his supervisor to grade a Python assignment strictly, Samuel spotted out 15+ critical errors for each submission. The mean score before adjustment was almost "0".', 
